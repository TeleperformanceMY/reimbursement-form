...
export const translations = {
  en: {
    ...
    clientEntertainmentAssisting: "Client Entertainment - Assisting Client",
    ...
    totalClientEntertainmentAssisting: "Total Client Entertainment - Assisting",
  ...
  zh: {
    ...
    clientEntertainmentAssisting: "客户招待 - 协助客户",
    ...
    totalClientEntertainmentAssisting: "客户招待-协助 总计",
    grandTotal: "总计",
    attachments: "附件",
    addAttachment: "添加文件",
  ...
  ja: {
    ...
    clientEntertainmentAssisting: "クライアント接待 - アシスト",
    ...
    totalClientEntertainmentAssisting: "クライアント接待-アシスト 合計",
    grandTotal: "総計",
    attachments: "添付ファイル",
